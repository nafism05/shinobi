          ...
          "blocks": {
             ...
             "Detector": {
                ...
                "info": [
                   ...
                   },
                   {
                    ...
                    {
                      hidden: true,
                      "name": "AwPython Detection",
                      "color": "orange",
                      id: "monSectionAwPythonModule",
                      headerTitle: `AwPython Detection<a class="pull-right btn btn-xs btn-default refresh_awpmodule" title="Refresh List of Awpmodule">&nbsp;<i class="fa fa-retweet"></i>&nbsp;</a>`,
                      isSection: true,
                      isAdvanced: true,
                      isFormGroupGroup: true,
                      "section-pre-pre-class": "h_det_input h_det_1",
                      "section-pre-class": "h_casc_input h_casc_1",
                      "section-class": "shinobi-detector-awpython shinobi-detector_plug",
                      "info": [
                          {
                              "fieldType": "div",
                              id: "detector_awpmodule_list",
                              style: "max-height: 300px; overflow: auto;"
                          }
                      ]
                    },
             ...
             "Hidden": {
                ...
                "info": [
                    ...
                    // --- ADDED CODE ---
                    {
                      "name": "detail=detector_awpmodule",
                    },
                    // --- ADDED CODE ---
