...
// --- ADDED CODE ---
$.aM.e.find('.refresh_awpmodule').click(function(e){
    $.ccio.cx({f:'ocv_in',data:{f:'refreshAwpmodule',ke:$user.ke}})
})
// --- ADDED CODE ---
...
// --- ADDED CODE ---
$.aM.e.on('change','.detector_awpmodule_selection',function(){
    var e={};
    e.e=$.aM.e.find('.detector_awpmodule_selection:checked');
    e.s={};
    e.e.each(function(n,v){
        e.s[$(v).val()]={}
    });
    $.aM.e.find('[detail="detector_awpmodule"]').val(JSON.stringify(e.s)).change()
})
// --- ADDED CODE ---
//$.aM.e.on('change','.detector_cascade_selection',function(){
//  var e={};
